...
def send_request(url):
    ...
    try:
        ...
        if status == 200:
            print(f"HTTP-REQUESTS | HenryNET Attack Sent | Status: 200")
        elif status == 500:
            print(f"HTTP-REQUESTS | HenryNET Attack Sent | Status: 500 ERROR WEBSITE SERVER IS DOWN")
        else:
...
""")
    ...
    duration = int(input("\033[1;97m[\033[1;96m*\033[1;97m] \033[1;96mThời gian\033[0m (\033[1;92mGiây\033[0m): ").strip())
    threads_count = int(input("\033[1;97m[\033[1;96m*\033[1;97m] \033[1;96mSố lượng luồng\033[0m: ").strip())
